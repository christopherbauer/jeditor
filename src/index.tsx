          ...
          switch (typeof jsonValue) {
            case 'string':
              nodeArray.push(
                ...
                >
                  {keyFormat(key)}:{' '}
                  <span className={`${classes.interact} ${classes.editorString}`}>
                    "{jsonValue}"
                  </span>{' '}
                  {i < keys.length - 1 ? ',' : ''}
                </DisplayEditor>
            ...
            case 'number':
              nodeArray.push(
                ...
                >
                  {keyFormat(key)}:{' '}
                  <span className={`${classes.interact} ${classes.editorNumber}`}>
                    {jsonValue}
                  </span>{' '}
                  {i < keys.length - 1 ? ',' : ''}
                </DisplayEditor>
            ...
            case 'boolean':
              nodeArray.push(
                ...
                >
                  {keyFormat(key)}:{' '}
                  <span
                    className={`${classes.interact} ${jsonValue ? classes.editorBooleanTrue : classes.editorBooleanFalse}`}
                  >
                    {jsonValue.toString()}
                  </span>{' '}
                  {i < keys.length - 1 ? ',' : ''}
